...
# Define the callback function to update the display based on the selected statistics and year
@app.callback(
    ...
    if selected_statistics == 'Recession Period Statistics':
        ...
        R_chart3 = dcc.Graph(
            figure=px.pie(
                ...
                title='Advertisement Expenditure Share by Vehicle Type (Recession)')
        )
